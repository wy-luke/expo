...
internal protocol AnySyncFunctionDefinition: AnyFunctionDefinition, ~Copyable {
  ...
  @discardableResult
  @JavaScriptActor
  func call(_ appContext: AppContext, this: JavaScriptValue, arguments: consuming JavaScriptValuesBuffer) throws(Exception) -> JavaScriptValue
}
...
//  func call(_ appContext: AppContext, this: JavaScriptValue, arguments: consuming JavaScriptValuesBuffer, callback: @escaping @Sendable (consuming FunctionCallResult) -> Void) {
//    do {
